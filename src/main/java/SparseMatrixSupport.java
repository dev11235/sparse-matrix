...
public interface SparseMatrixSupport<M> {
   ...
   * @return a stream of integers, where the first element is a number of rows, the second is a
   * number of columns.
   */
   ...
   *
   * @param stream a stream of integers like in the corresponding {@link
   * SparseMatrixSupport#toStream} method
